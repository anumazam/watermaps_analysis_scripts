...
def color_b(selection='all',item='b',mode='hist',gradient='bgr',nbins=15,sat=1.,value=1.,minimum='',maximum='',user_rgb='',debug=0):
  """
...
#  if debug:
#    for j in range(nbins):
#      print("colour #:",j,"colour RGB triplet: ",col[j])'re'
